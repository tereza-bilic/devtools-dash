...
levels: list[Level] = [
    ...
    Level(key="s3", title="Retracing the Steps", category=CategoryEnum.Sources, order_in_category=3, difficulty=3),
    Level(key="s4", title="Error Tracker", category=CategoryEnum.Sources, order_in_category=4, difficulty=3),
